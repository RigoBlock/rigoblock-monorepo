...
export class RigoToken extends TypeChainContract {
  ...
  public get minter(): Promise<string> {
    return promisify(this.rawWeb3Contract.minter, []);
  }
  public get getSymbol(): Promise<string> {
    return promisify(this.rawWeb3Contract.getSymbol, []);
  }
  public get getName(): Promise<string> {
    return promisify(this.rawWeb3Contract.getName, []);
  }
  ...
  public get rigoblock(): Promise<string> {
    return promisify(this.rawWeb3Contract.rigoblock, []);
  }
  public get getRigoblock(): Promise<string> {
    return promisify(this.rawWeb3Contract.getRigoblock, []);
  }
  public get symbol(): Promise<string> {
    return promisify(this.rawWeb3Contract.symbol, []);
  }
  public get getDecimals(): Promise<BigNumber> {
    return promisify(this.rawWeb3Contract.getDecimals, []);
  }
  public get getMinter(): Promise<string> {
    return promisify(this.rawWeb3Contract.getMinter, []);
  }
  ...
  public mintTokenTx(
    ...
    return new DeferredTransactionWrapper<ITxParams>(this, "mintToken", [
      _recipient.toString(),
      _amount.toString()
    ]);
  }
