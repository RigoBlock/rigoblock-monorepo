...
export class DragoRegistry extends TypeChainContract {
  ...
  public get getGroups(): Promise<string[]> {
    return promisify(this.rawWeb3Contract.getGroups, []);
  }
  public get dragoCount(): Promise<BigNumber> {
    return promisify(this.rawWeb3Contract.dragoCount, []);
  }
  public get getFee(): Promise<BigNumber> {
    return promisify(this.rawWeb3Contract.getFee, []);
  }
  public get fee(): Promise<BigNumber> {
    return promisify(this.rawWeb3Contract.fee, []);
  }
  public get VERSION(): Promise<BigNumber> {
    return promisify(this.rawWeb3Contract.VERSION, []);
  }
  public fromNameSymbol(_name: string, _symbol: string): Promise<string> {
    return promisify(this.rawWeb3Contract.fromNameSymbol, [
      _name.toString(),
      _symbol.toString()
    ]);
  }
  public meta(_id: BigNumber | number, _key: BigNumber): Promise<BigNumber> {
    return promisify(this.rawWeb3Contract.meta, [
      _id.toString(),
      _key.toString()
    ]);
  }
  public getNameFromAddress(_pool: BigNumber | string): Promise<BigNumber> {
    return promisify(this.rawWeb3Contract.getNameFromAddress, [
      _pool.toString()
    ]);
  }
  public fromName(
    ...
    return promisify(this.rawWeb3Contract.fromName, [_name.toString()]);
  }
  public fromSymbol(
    _symbol: string
  ): Promise<[BigNumber, string, string, BigNumber, string, string]> {
    return promisify(this.rawWeb3Contract.fromSymbol, [_symbol.toString()]);
  }
  public fromAddress(
    _drago: BigNumber | string
  ): Promise<[BigNumber, string, string, BigNumber, string, string]> {
    return promisify(this.rawWeb3Contract.fromAddress, [_drago.toString()]);
  }
  public fromId(
    _id: BigNumber | number
  ): Promise<[string, string, string, BigNumber, string, string]> {
    return promisify(this.rawWeb3Contract.fromId, [_id.toString()]);
  }
  public getSymbolFromAddress(_pool: BigNumber | string): Promise<BigNumber> {
    return promisify(this.rawWeb3Contract.getSymbolFromAddress, [
      _pool.toString()
    ]);
  }
  ...
  public upgradeTx(
    ...
    return new DeferredTransactionWrapper<IPayableTxParams>(this, "upgrade", [
  ...
  public registerTx(
    ...
    return new DeferredTransactionWrapper<IPayableTxParams>(this, "register", [
      _drago.toString(),
      _name.toString(),
      _symbol.toString(),
      _dragoId.toString(),
  ...
  public setUpgradedTx(
    ...
    return new DeferredTransactionWrapper<ITxParams>(this, "setUpgraded", [
      _version.toString()
    ]);
  }
  public setFeeTx(
  ...
  public unregisterTx(
    ...
    return new DeferredTransactionWrapper<ITxParams>(this, "unregister", [
      _id.toString()
    ]);
  }
  public setMetaTx(
    ...
    return new DeferredTransactionWrapper<ITxParams>(this, "setMeta", [
      _id.toString(),
      _key.toString(),
      _value.toString()
    ]);
  ...
  public addGroupTx(
    ...
    return new DeferredTransactionWrapper<ITxParams>(this, "addGroup", [
      _group.toString()
    ]);
  }
}
