...
export class WrapperLock extends TC.TypeChainContract {
  ...
  static async createAndValidate(
    ...
    const contract = new WrapperLock(web3, address);
  ...
  public get erc20old(): Promise<boolean> {
    return TC.promisify(this.rawWeb3Contract.erc20old, []);
  }
  ...
  public withdrawBalanceDifferenceTx(): TC.DeferredTransactionWrapper<
    TC.ITxParams
  > {
  ...
  public withdrawDifferentTokenTx(
    _differentToken: BigNumber | string,
    _erc20old: boolean
  ): TC.DeferredTransactionWrapper<TC.ITxParams> {
    return new TC.DeferredTransactionWrapper<TC.ITxParams>(
      this,
      "withdrawDifferentToken",
      [_differentToken.toString(), _erc20old.toString()]
    );
  }
  public depositTx(
    _value: BigNumber | number,
    ...
    return new TC.DeferredTransactionWrapper<TC.ITxParams>(this, "deposit", [
      _value.toString(),
      _forTime.toString()
    ]);
  }
