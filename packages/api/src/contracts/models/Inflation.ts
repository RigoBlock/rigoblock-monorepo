...
export class Inflation extends TC.TypeChainContract {
  ...
  public get proofOfPerformance(): Promise<string> {
    return TC.promisify(this.rawWeb3Contract.proofOfPerformance, []);
  }

  public get period(): Promise<BigNumber> {
    return TC.promisify(this.rawWeb3Contract.period, []);
  }

  public canWithdraw(_thePool: BigNumber | string): Promise<boolean> {
    return TC.promisify(this.rawWeb3Contract.canWithdraw, [
      _thePool.toString()
    ]);
  }
  ...
  public setPeriodTx(
    ...
    return new TC.DeferredTransactionWrapper<TC.ITxParams>(this, "setPeriod", [
      _newPeriod.toString()
    ]);
  }
  ...
  public mintInflationTx(
    ...
    return new TC.DeferredTransactionWrapper<TC.ITxParams>(
      this,
      "mintInflation",
      [_thePool.toString(), _reward.toString()]
    );
  }
