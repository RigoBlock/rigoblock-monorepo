...
export class UnlimitedAllowanceToken extends TC.TypeChainContract {
  ...
  ): Promise<UnlimitedAllowanceToken> {
    const contract = new UnlimitedAllowanceToken(web3, address);
