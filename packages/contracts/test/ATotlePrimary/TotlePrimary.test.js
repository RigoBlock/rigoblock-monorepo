...
describeContract(contractName, () => {
  ...
  beforeAll(async () => {
    ...
    tokenTransferProxyAddress = await baseContracts['TokenTransferProxy']
      .address
    zeroExHandlerAddress = await baseContracts['ZeroExExchangeHandler'].address
    totlePrimaryAddress = await baseContracts['TotlePrimary'].address
...
*/
      ...
      const tradeId =
        '0xfa39c1a29cab1aa241b62c2fd067a6602a9893c2afe09aaea371609e11cbd92d' // mock id bytes32
